...
<div class="page-content-wrap clearfix">
    <form action="/doAddReleaseTest" class="layui-form" enctype="multipart/form-data" method="post">
        <div class="layui-tab">
            <ul class="layui-tab-title">
                <%--<li><a href="/toReleaseTest">发布测试</a></li>--%>
                <li class="layui-this">发布测试</li>
            </ul>
                ...
                <div class="layui-tab-item layui-show">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="reltitle" required lay-verify="required" placeholder="请输入标题名称" class="layui-input">
                        </div>
                    </div>
                 <%--   <div class="layui-form-item">
