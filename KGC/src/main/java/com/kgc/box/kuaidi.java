...
public class kuaidi {
	public static void main(String[] args) {
        ...
        try {
	    	...
	    	*/
                HttpResponse response = com.kgc.box.HttpUtils.doGet(host, path, method, headers, querys);
